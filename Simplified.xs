...
#define PkgName "Lingua::ZH::MacChinese::Simplified"

#define FromMbTbl	fm_maccns
#define ToMbTbl 	to_maccns
#define ToMbTblC	to_maccns_contra

#define IsMbSGL(i)   (0x00<=(i) && (i)<=0xA0 || 0xFD<=(i) && (i)<=0xFF)
#define IsMbLED(i)   (0xA1<=(i) && (i)<=0xFC)
#define IsMbTRL(i)   (0xA1<=(i) && (i)<=0xFE)
...
MODULE = Lingua::ZH::MacChinese::Simplified	PACKAGE = Lingua::ZH::MacChinese::Simplified
PROTOTYPES: DISABLE
